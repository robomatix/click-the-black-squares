...
(function () {
    var a = this, b = b || {};
    b.WEBGL_RENDERER = 0, b.CANVAS_RENDERER = 1, b.VERSION = "v1.6", b.blendModes = {NORMAL: 0, ADD: 1, MULTIPLY: 2, SCREEN: 3, OVERLAY: 4, DARKEN: 5, LIGHTEN: 6, COLOR_DODGE: 7, COLOR_BURN: 8, HARD_LIGHT: 9, SOFT_LIGHT: 10, DIFFERENCE: 11, EXCLUSION: 12, HUE: 13, SATURATION: 14, COLOR: 15, LUMINOSITY: 16}, b.scaleModes = {DEFAULT: 0, LINEAR: 0, NEAREST: 1}, b._UID = 0, b.Float32Array = Float32Array || Array, b.Uint16Array = Uint16Array || Array, b.INTERACTION_FREQUENCY = 30, b.AUTO_PREVENT_DEFAULT = !0, b.RAD_TO_DEG = 180 / Math.PI, b.DEG_TO_RAD = Math.PI / 180, b.dontSayHello = !1, b.sayHello = function (a) {
        if (!b.dontSayHello) {
            if (navigator.userAgent.toLowerCase().indexOf("chrome") > -1) {
                var c = ["%c %c %c Pixi.js " + b.VERSION + " - " + a + "  %c  %c  http://pixijs.com  %c %c ♥%c♥%c♥ ", "background: #ff66a5", "background: #ff66a5", "color: #ff66a5; background: #030307;", "background: #ff66a5", "background: #ffc3dc", "background: #ff66a5", "color: #ff2424; background: #fff", "color: #ff2424; background: #fff", "color: #ff2424; background: #fff"];
                console.log.apply(console, c)
            } else window.console && console.log("Pixi.js " + b.VERSION + " - http://pixjs.com");
            b.dontSayHello = !0
        }
    ...
    }, b.DisplayObjectContainer.prototype = Object.create(b.DisplayObject.prototype), b.DisplayObjectContainer.prototype.constructor = b.DisplayObjectContainer, Object.defineProperty(b.DisplayObjectContainer.prototype, "width", {get: function () {
        return this.scale.x * this.getLocalBounds().width
    }, set: function (a) {
        this.scale.x = a / (this.getLocalBounds().width / this.scale.x), this._width = a
    }}), Object.defineProperty(b.DisplayObjectContainer.prototype, "height", {get: function () {
        return this.scale.y * this.getLocalBounds().height
    }, set: function (a) {
        this.scale.y = a / (this.getLocalBounds().height / this.scale.y), this._height = a
        ...
        this.texture.baseTexture !== a.baseTexture ? (this.textureChange = !0, this.texture = a) : this.texture = a, this.cachedTint = 16777215
    ...
    window.requestAnimationFrame || (window.requestAnimationFrame = function (a) {
        ...
        var e = a.points, f = e[0], g = e[1], h = e[2], i = e[3], j = e[4], k = [];
        if (k.push(f, g + j), k = k.concat(d(f, g + i - j, f, g + i, f + j, g + i)), k = k.concat(d(f + h - j, g + i, f + h, g + i, f + h, g + i - j)), k = k.concat(d(f + h, g + j, f + h, g, f + h - j, g)), k = k.concat(d(f + j, g, f, g, f, g + j)), a.fill) {
            var l = b.hex2rgb(a.fillColor), m = a.fillAlpha, n = l[0] * m, o = l[1] * m, p = l[2] * m, q = c.points, r = c.indices, s = q.length / 6, t = b.PolyK.Triangulate(k), u = 0;
            for (u = 0; u < t.length; u += 3)r.push(t[u] + s), r.push(t[u] + s), r.push(t[u + 1] + s), r.push(t[u + 2] + s), r.push(t[u + 2] + s);
            for (u = 0; u < k.length; u++)q.push(k[u], k[++u], n, o, p, m)
        }
        if (a.lineWidth) {
            var v = a.points;
            a.points = k, b.WebGLGraphics.buildLine(a, c), a.points = v
        }
        ...
        this.drawing = !1, this.currentBatchSize = 0, this.currentBaseTexture = null, this.setContext(a), this.dirty = !0
        ...
        var b = a.texture, c = this.renderSession.blendModeManager.currentBlendMode !== a.blendMode;
        (b.baseTexture !== this.currentBaseTexture || this.currentBatchSize >= this.size || c) && (this.flush(), this.currentBaseTexture = b.baseTexture, this.renderSession.blendModeManager.setBlendMode(a.blendMode));
        var d = b._uvs;
        if (d) {
            var e, f, g, h, i = a.worldAlpha, j = a.tint, k = this.vertices, l = a.anchor.x, m = a.anchor.y;
            if (b.trim) {
                var n = b.trim;
                f = n.x - l * n.width, e = f + b.crop.width, h = n.y - m * n.height, g = h + b.crop.height
            } else e = b.frame.width * (1 - l), f = b.frame.width * -l, g = b.frame.height * (1 - m), h = b.frame.height * -m;
            var o = 4 * this.currentBatchSize * this.vertSize, p = a.worldTransform, q = p.a, r = p.c, s = p.b, t = p.d, u = p.tx, v = p.ty;
            k[o++] = q * f + s * h + u, k[o++] = t * h + r * f + v, k[o++] = d.x0, k[o++] = d.y0, k[o++] = i, k[o++] = j, k[o++] = q * e + s * h + u, k[o++] = t * h + r * e + v, k[o++] = d.x1, k[o++] = d.y1, k[o++] = i, k[o++] = j, k[o++] = q * e + s * g + u, k[o++] = t * g + r * e + v, k[o++] = d.x2, k[o++] = d.y2, k[o++] = i, k[o++] = j, k[o++] = q * f + s * g + u, k[o++] = t * g + r * f + v, k[o++] = d.x3, k[o++] = d.y3, k[o++] = i, k[o++] = j, this.currentBatchSize++
        }
    }, b.WebGLSpriteBatch.prototype.renderTilingSprite = function (a) {
        var c = a.tilingTexture, d = this.renderSession.blendModeManager.currentBlendMode !== a.blendMode;
        (c.baseTexture !== this.currentBaseTexture || this.currentBatchSize >= this.size || d) && (this.flush(), this.currentBaseTexture = c.baseTexture, this.renderSession.blendModeManager.setBlendMode(a.blendMode)), a._uvs || (a._uvs = new b.TextureUvs);
        var e = a._uvs;
        a.tilePosition.x %= c.baseTexture.width * a.tileScaleOffset.x, a.tilePosition.y %= c.baseTexture.height * a.tileScaleOffset.y;
        var f = a.tilePosition.x / (c.baseTexture.width * a.tileScaleOffset.x), g = a.tilePosition.y / (c.baseTexture.height * a.tileScaleOffset.y), h = a.width / c.baseTexture.width / (a.tileScale.x * a.tileScaleOffset.x), i = a.height / c.baseTexture.height / (a.tileScale.y * a.tileScaleOffset.y);
        e.x0 = 0 - f, e.y0 = 0 - g, e.x1 = 1 * h - f, e.y1 = 0 - g, e.x2 = 1 * h - f, e.y2 = 1 * i - g, e.x3 = 0 - f, e.y3 = 1 * i - g;
        var j = a.worldAlpha, k = a.tint, l = this.vertices, m = a.width, n = a.height, o = a.anchor.x, p = a.anchor.y, q = m * (1 - o), r = m * -o, s = n * (1 - p), t = n * -p, u = 4 * this.currentBatchSize * this.vertSize, v = a.worldTransform, w = v.a, x = v.c, y = v.b, z = v.d, A = v.tx, B = v.ty;
        l[u++] = w * r + y * t + A, l[u++] = z * t + x * r + B, l[u++] = e.x0, l[u++] = e.y0, l[u++] = j, l[u++] = k, l[u++] = w * q + y * t + A, l[u++] = z * t + x * q + B, l[u++] = e.x1, l[u++] = e.y1, l[u++] = j, l[u++] = k, l[u++] = w * q + y * s + A, l[u++] = z * s + x * q + B, l[u++] = e.x2, l[u++] = e.y2, l[u++] = j, l[u++] = k, l[u++] = w * r + y * s + A, l[u++] = z * s + x * r + B, l[u++] = e.x3, l[u++] = e.y3, l[u++] = j, l[u++] = k, this.currentBatchSize++
        ...
        if (0 !== this.currentBatchSize) {
            ...
            if (this.renderSession.shaderManager.setShader(this.renderSession.shaderManager.defaultShader), this.dirty) {
                ...
                a.vertexAttribPointer(this.shader.aVertexPosition, 2, a.FLOAT, !1, d, 0), a.vertexAttribPointer(this.shader.aTextureCoord, 2, a.FLOAT, !1, d, 8), a.vertexAttribPointer(this.shader.colorAttribute, 2, a.FLOAT, !1, d, 16)
            }
            if (a.bindTexture(a.TEXTURE_2D, this.currentBaseTexture._glTextures[a.id] || b.createWebGLTexture(this.currentBaseTexture, a)), this.currentBaseTexture._dirty[a.id] && b.updateWebGLTexture(this.currentBaseTexture, a), this.currentBatchSize > .5 * this.size)a.bufferSubData(a.ARRAY_BUFFER, 0, this.vertices); else {
        ...
        for (var e, f, g = 20, h = this.currentPath.points, i = h[h.length - 2], j = h[h.length - 1], k = 0, l = 1; g >= l; l++)k = l / g, e = i + (a - i) * k, f = j + (b - j) * k, h.push(e + (a + (c - a) * k - e) * k, f + (b + (d - b) * k - f) * k);
        ...
        var g = a + Math.cos(d) * c, h = b + Math.sin(d) * c, i = this.currentPath.points, j = i[i.length - 2], k = i[i.length - 1];
        if ((j !== g || k !== h) && i.push(g, h), d === e)return this;
        !f && d >= e ? e += 2 * Math.PI : f && e >= d && (d += 2 * Math.PI);
        var l = f ? -1 * (d - e) : e - d, m = Math.abs(l) / (2 * Math.PI) * 40;
        if (0 === l)return this;
        for (var n = l / (2 * m), o = 2 * n, p = Math.cos(n), q = Math.sin(n), r = m % 1 / m, s = 0; m >= s; s++) {
            var t = s + r * s, u = n + d + o * t, v = Math.cos(u), w = -Math.sin(u);
            i.push((p * v + q * w) * c + a, (p * -w + q * v) * c + b)
        }
        return this.dirty = !0, this
    },b.Graphics.prototype.drawPath = function (a) {
        return this.currentPath.points.length || this.graphicsData.pop(), this.currentPath = this.currentPath = {lineWidth: this.lineWidth, lineColor: this.lineColor, lineAlpha: this.lineAlpha, fillColor: this.fillColor, fillAlpha: this.fillAlpha, fill: this.filling, points: [], type: b.Graphics.POLY}, this.graphicsData.push(this.currentPath), this.currentPath.points = this.currentPath.points.concat(a), this.dirty = !0, this
        ...
        return this.currentPath.points.length || this.graphicsData.pop(), this.currentPath = {lineWidth: this.lineWidth, lineColor: this.lineColor, lineAlpha: this.lineAlpha, fillColor: this.fillColor, fillAlpha: this.fillAlpha, fill: this.filling, points: [a, c, d, e, f], type: b.Graphics.RREC}, this.graphicsData.push(this.currentPath), this.dirty = !0, this
    ...
    if (PIXI.InteractionManager = PIXI.InteractionManager || function () {
        ...
        if ("string" != typeof c && (c = (c % 360 + 360) % 360), 90 === c || -270 === c || "rotateLeft" === c)a = b.Utils.transposeArray(a), a = a.reverse(); else if (-90 === c || 270 === c || "rotateRight" === c)a = a.reverse(), a = b.Utils.transposeArray(a); else if (180 === Math.abs(c) || "rotate180" === c) {
    ...
    window.console || (window.console = {}, window.console.log = window.console.assert = function () {
    ...
    }}), Object.defineProperty(b.Rectangle.prototype, "randomX", {get: function () {
        return this.x + Math.random() * this.width
    }}), Object.defineProperty(b.Rectangle.prototype, "randomY", {get: function () {
        ...
        if (g.x = (j * m - k * l) / n, g.y = (i * l - h * m) / n, f) {
            var o = (e.y - d.y) * (c.x - a.x) - (e.x - d.x) * (c.y - a.y), p = ((e.x - d.x) * (a.y - d.y) - (e.y - d.y) * (a.x - d.x)) / o, q = ((c.x - a.x) * (a.y - d.y) - (c.y - a.y) * (a.x - d.x)) / o;
        ...
        return c
    }},b.Polygon.prototype.constructor = b.Polygon,Object.defineProperty(b.Polygon.prototype, "points", {get: function () {
        return this._points
    }, set: function (a) {
        if (a instanceof Array || (a = Array.prototype.slice.call(arguments)), "number" == typeof a[0]) {
            for (var c = [], d = 0, e = a.length; e > d; d += 2)c.push(new b.Point(a[d], a[d + 1]));
        ...
        this._points = a
    }}),Object.defineProperty(b.Polygon.prototype, "area", {get: function () {
    ...
    },b.ArrayList.prototype = {add: function (a) {
    ...
    }},Object.defineProperty(b.ArrayList.prototype, "first", {get: function () {
        return this.position = 0, this.total > 0 ? this.list[0] : null
    }}),Object.defineProperty(b.ArrayList.prototype, "next", {get: function () {
    ...
    },b.Keyboard.prototype = {addCallbacks: function (a, b, c, d) {
        ...
        this.pressEvent = a, this.onPressCallback && this.onPressCallback.call(this.callbackContext, String.fromCharCode(a.charCode), a)
    }, processKeyUp: function (a) {
    ...
    }},Object.defineProperty(b.Keyboard.prototype, "lastChar", {get: function () {
        return 32 === this.event.charCode ? "" : String.fromCharCode(this.pressEvent.charCode)
    }}),Object.defineProperty(b.Keyboard.prototype, "lastKey", {get: function () {
    ...
    },b.Mouse.NO_BUTTON = -1,b.Mouse.LEFT_BUTTON = 0,b.Mouse.MIDDLE_BUTTON = 1,b.Mouse.RIGHT_BUTTON = 2,b.Mouse.WHEEL_UP = 1,b.Mouse.WHEEL_DOWN = -1,b.Mouse.prototype = {start: function () {
        ...
        if (!(!this.connected || this.game.input.disabled || this.game.input.gamepad.disabled || this._rawPad.timestamp && this._rawPad.timestamp === this._prevTimestamp)) {
            ...
            for (var c = 0; c < this._axesLen; c++) {
                ...
                this.processAxisChange(d > 0 && d > this.deadZone || 0 > d && d < -this.deadZone ? {axis: c, value: d} : {axis: c, value: 0})
            }
        ...
        return a.isDown && this.enabled && this.sprite && this.sprite.parent && this.sprite.visible && this.sprite.parent.visible && this.game.input.hitTest(this.sprite, a, this._tempPoint) ? this.pixelPerfectClick ? this.checkPixel(this._tempPoint.x, this._tempPoint.y) : !0 : !1
        ...
        (a !== this.width || b !== this.height) && (this.width = a, this.height = b, this.canvas.width = a, this.canvas.height = b, this.baseTexture.width = a, this.baseTexture.height = b, this.textureFrame.width = a, this.textureFrame.height = b, this.texture.width = a, this.texture.height = b, this.refreshBuffer(), this.dirty = !0)
        ...
        for (var h = d + f, i = e + g, j = b.Color.createColor(), k = {r: 0, g: 0, b: 0, a: 0}, l = !1, m = e; i > m; m++)for (var n = d; h > n; n++)b.Color.unpackPixel(this.getPixel32(n, m), j), k = a.call(c, j, n, m), k !== !1 && null !== k && void 0 !== k && (this.setPixel32(n, m, k.r, k.g, k.b, k.a, !1), l = !0);
        ...
        var k = 0, l = 0, m = this.width, n = this.height, o = b.Color.packPixel(a, c, d, e);
        ...
        if (("undefined" == typeof a || null === a) && (a = !1), ("undefined" == typeof c || null === c) && (c = !1), ("undefined" == typeof d || null === d) && (d = !1), a || c || d) {
            ...
            for (var f = b.Color.createColor(), g = e.y; g < e.bottom; g++)for (var h = e.x; h < e.right; h++)b.Color.unpackPixel(this.getPixel32(h, g), f, !0), a && (f.h = a), c && (f.s = c), d && (f.l = d), b.Color.HSLtoRGB(f.h, f.s, f.l, f), this.setPixel32(h, g, f.r, f.g, f.b, f.a, !1);
            this.context.putImageData(this.imageData, 0, 0), this.dirty = !0
        }
    }, shiftHSL: function (a, c, d, e) {
        if (("undefined" == typeof a || null === a) && (a = !1), ("undefined" == typeof c || null === c) && (c = !1), ("undefined" == typeof d || null === d) && (d = !1), a || c || d) {
            "undefined" == typeof e && (e = new b.Rectangle(0, 0, this.width, this.height));
            for (var f = b.Color.createColor(), g = e.y; g < e.bottom; g++)for (var h = e.x; h < e.right; h++)b.Color.unpackPixel(this.getPixel32(h, g), f, !0), a && (f.h = this.game.math.wrap(f.h + a, 0, 1)), c && (f.s = this.game.math.limitValue(f.s + c, 0, 1)), d && (f.l = this.game.math.limitValue(f.l + d, 0, 1)), b.Color.HSLtoRGB(f.h, f.s, f.l, f), this.setPixel32(h, g, f.r, f.g, f.b, f.a, !1);
            this.context.putImageData(this.imageData, 0, 0), this.dirty = !0
        }
        ...
        c = c || 0, this.key = a;
        var d = !0;
        a instanceof b.RenderTexture ? (this.key = a.key, this.setTexture(a)) : a instanceof b.BitmapData ? this.setTexture(a.texture) : a instanceof PIXI.Texture ? this.setTexture(a) : null === a || "undefined" == typeof a ? (this.key = "__default", this.setTexture(PIXI.TextureCache[this.key])) : "string" != typeof a || this.game.cache.checkImageKey(a) ? (this.setTexture(new PIXI.Texture(PIXI.BaseTextureCache[a])), this.animations && (d = !this.animations.loadFrameData(this.game.cache.getFrameData(a), c))) : (this.key = "__missing", this.setTexture(PIXI.TextureCache[this.key])), d && (this._frame = b.Rectangle.clone(this.texture.frame))
    },b.Sprite.prototype.setFrame = function (a) {
        this._frame = a, this.texture.frame.x = a.x, this.texture.frame.y = a.y, this.texture.frame.width = a.width, this.texture.frame.height = a.height, this.texture.crop.x = a.x, this.texture.crop.y = a.y, this.texture.crop.width = a.width, this.texture.crop.height = a.height, a.trimmed && (this.texture.trim ? (this.texture.trim.x = a.spriteSourceSizeX, this.texture.trim.y = a.spriteSourceSizeY, this.texture.trim.width = a.sourceSizeW, this.texture.trim.height = a.sourceSizeH) : this.texture.trim = {x: a.spriteSourceSizeX, y: a.spriteSourceSizeY, width: a.sourceSizeW, height: a.sourceSizeH}, this.texture.width = a.sourceSizeW, this.texture.height = a.sourceSizeH, this.texture.frame.width = a.sourceSizeW, this.texture.frame.height = a.sourceSizeH), this.cropRect ? this.updateCrop() : this.game.renderType === b.WEBGL && PIXI.WebGLRenderer.updateTextureFrame(this.texture)
        ...
        if (this.cropRect) {
            ...
            var a = Math.max(this._frame.x, this._crop.x), c = Math.max(this._frame.y, this._crop.y), d = Math.min(this._frame.right, this._crop.right) - a, e = Math.min(this._frame.bottom, this._crop.bottom) - c;
        ...
        if (c = c || 0, this.key = a, a instanceof b.RenderTexture)this.key = a.key, this.setTexture(a); else if (a instanceof b.BitmapData)this.setTexture(a.texture); else if (a instanceof PIXI.Texture)this.setTexture(a); else if (null === a || "undefined" == typeof a)this.key = "__default", this.setTexture(PIXI.TextureCache[this.key]); else if ("string" != typeof a || this.game.cache.checkImageKey(a))if (this.game.cache.isSpriteSheet(a)) {
            var d = this.game.cache.getFrameData(a);
            this.setTexture("string" == typeof c ? new PIXI.Texture(PIXI.BaseTextureCache[a], d.getFrameByName(c)) : new PIXI.Texture(PIXI.BaseTextureCache[a], d.getFrame(c)))
        } else this.setTexture(new PIXI.Texture(PIXI.BaseTextureCache[a])); else this.key = "__missing", this.setTexture(PIXI.TextureCache[this.key]);
        this._frame = b.Rectangle.clone(this.texture.frame)
    },b.Image.prototype.resetFrame = b.Sprite.prototype.resetFrame,b.Image.prototype.setFrame = b.Sprite.prototype.setFrame,b.Image.prototype.updateCrop = b.Sprite.prototype.updateCrop,b.Image.prototype.crop = b.Sprite.prototype.crop,b.Image.prototype.revive = function () {
        return this.alive = !0, this.exists = !0, this.visible = !0, this.events && this.events.onRevived.dispatch(this), this
    },b.Image.prototype.kill = b.Sprite.prototype.kill,b.Image.prototype.destroy = b.Sprite.prototype.destroy,b.Image.prototype.reset = function (a, b) {
    ...
    },b.Image.prototype.bringToTop = b.Sprite.prototype.bringToTop,Object.defineProperty(b.Image.prototype, "angle", {get: function () {
        return b.Math.wrapAngle(b.Math.radToDeg(this.rotation))
    }, set: function (a) {
        this.rotation = b.Math.degToRad(b.Math.wrapAngle(a))
        ...
        if (a !== this.frame && this.game.cache.isSpriteSheet(this.key)) {
            ...
            b && a < b.total && b.getFrame(a) && (this._cache[9] = a, this.setFrame(b.getFrame(a)))
        }
        ...
        if (a !== this.frameName && this.game.cache.isSpriteSheet(this.key)) {
            var b = this.game.cache.getFrameData(this.key);
            b && b.getFrameByName(a) && (this._frameName = a, this.setFrame(b.getFrameByName(a)))
        }
        ...
        a ? this.texture && (this.texture.baseTexture.scaleMode = 0) : this.texture && (this.texture.baseTexture.scaleMode = 1)
    }}),Object.defineProperty(b.Image.prototype, "destroyPhase", {get: function () {
        return!!this._cache[8]
        ...
        c = c || 0, this.key = a, a instanceof b.RenderTexture ? (this.key = a.key, this.setTexture(a)) : a instanceof b.BitmapData ? this.setTexture(a.texture) : a instanceof PIXI.Texture ? this.setTexture(a) : null === a || "undefined" == typeof a ? (this.key = "__default", this.setTexture(PIXI.TextureCache[this.key])) : "string" != typeof a || this.game.cache.checkImageKey(a) ? (this.setTexture(new PIXI.Texture(PIXI.BaseTextureCache[a])), this.animations.loadFrameData(this.game.cache.getFrameData(a), c)) : (this.key = "__missing", this.setTexture(PIXI.TextureCache[this.key]))
    },b.TileSprite.prototype.setFrame = function (a) {
        this.texture.frame.x = a.x, this.texture.frame.y = a.y, this.texture.frame.width = a.width, this.texture.frame.height = a.height, this.texture.crop.x = a.x, this.texture.crop.y = a.y, this.texture.crop.width = a.width, this.texture.crop.height = a.height, a.trimmed && (this.texture.trim ? (this.texture.trim.x = a.spriteSourceSizeX, this.texture.trim.y = a.spriteSourceSizeY, this.texture.trim.width = a.sourceSizeW, this.texture.trim.height = a.sourceSizeH) : this.texture.trim = {x: a.spriteSourceSizeX, y: a.spriteSourceSizeY, width: a.sourceSizeW, height: a.sourceSizeH}, this.texture.width = a.sourceSizeW, this.texture.height = a.sourceSizeH, this.texture.frame.width = a.sourceSizeW, this.texture.frame.height = a.sourceSizeH), this.game.renderType === b.WEBGL && PIXI.WebGLRenderer.updateTextureFrame(this.texture)
        ...
        this.position.y = a, this.body && this.body.type === b.Physics.ARCADE && 2 === this.body.phase && (this.body._reset = 1)
    }}),Object.defineProperty(b.TileSprite.prototype, "destroyPhase", {get: function () {
        return!!this._cache[8]
        ...
        a ? (this._cache[7] = 1, this.cameraOffset.set(this.x, this.y)) : this._cache[7] = 0
    }}),Object.defineProperty(b.Text.prototype, "destroyPhase", {get: function () {
        return!!this._cache[8]
        ...
        a ? (this._cache[7] = 1, this.cameraOffset.set(this.x, this.y)) : this._cache[7] = 0
    }}),Object.defineProperty(b.BitmapText.prototype, "destroyPhase", {get: function () {
        return!!this._cache[8]
        ...
        if (c) {
            var e = new b.Point(this.game.camera.x - a[0].x, this.game.camera.y - a[0].y), f = new b.Point(a[1].x - a[0].x, a[1].y - a[0].y), g = new b.Point(a[1].x - a[2].x, a[1].y - a[2].y), h = g.cross(f);
        ...
        if (c)if (a[0]instanceof b.Point)for (e = 0; e < c.length / 3; e++)i.push(a[c[3 * e]]), i.push(a[c[3 * e + 1]]), i.push(a[c[3 * e + 2]]), 3 === i.length && (this.drawTriangle(i, d), i = []); else for (e = 0; e < c.length; e++)f.x = a[2 * c[e]], f.y = a[2 * c[e] + 1], i.push(f.copyTo({})), 3 === i.length && (this.drawTriangle(i, d), i = []); else if (a[0]instanceof b.Point)for (e = 0; e < a.length / 3; e++)this.drawTriangle([a[3 * e], a[3 * e + 1], a[3 * e + 2]], d); else for (e = 0; e < a.length / 6; e++)f.x = a[6 * e + 0], f.y = a[6 * e + 1], g.x = a[6 * e + 2], g.y = a[6 * e + 3], h.x = a[6 * e + 4], h.y = a[6 * e + 5], this.drawTriangle([f, g, h], d)
        ...
        a ? (this._cache[7] = 1, this.cameraOffset.set(this.x, this.y)) : this._cache[7] = 0
    }}),Object.defineProperty(b.Graphics.prototype, "destroyPhase", {get: function () {
        return!!this._cache[8]
    ...
    }}),Object.defineProperty(b.RetroFont.prototype, "smoothed", {get: function () {
    ...
    },b.Device.LITTLE_ENDIAN = !1,b.Device.prototype = {_checkOS: function () {
        ...
        for (var a = ["requestFullscreen", "requestFullScreen", "webkitRequestFullscreen", "webkitRequestFullScreen", "msRequestFullscreen", "msRequestFullScreen", "mozRequestFullScreen", "mozRequestFullscreen"], b = 0; b < a.length; b++)if (this.game.canvas[a[b]]) {
        ...
        if (this.fullscreen)for (var b = 0; b < c.length; b++)if (document[c[b]]) {
        ...
        if (a instanceof b.Rectangle)var c = this.objects, d = this.getIndex(a); else {
            if (!a.body)return this._empty;
            var c = this.objects, d = this.getIndex(a.body)
        }
    ...
    },b.AnimationManager.prototype = {loadFrameData: function (a, b) {
        ...
        var c;
        if ("undefined" == typeof b && (b = !1), "string" == typeof a)for (var d = 0; d < this._frames.length; d++)this._frameData.getFrame(this._frames[d]).name === a && (c = d); else if ("number" == typeof a)if (b)c = a; else for (var d = 0; d < this._frames.length; d++)this.frames[d] === c && (c = d);
        ...
        for (var o = new b.FrameData, p = g, q = g, r = 0; n > r; r++) {
            var s = a.rnd.uuid();
            o.addFrame(new b.Frame(r, p, q, d, e, "", s)), p += d + h, p + d > j && (p = g, q += e + h)
        }
        return o
        ...
        for (var d, e = new b.FrameData, f = c.frames, g = 0; g < f.length; g++) {
            var h = a.rnd.uuid();
            d = e.addFrame(new b.Frame(g, f[g].frame.x, f[g].frame.y, f[g].frame.w, f[g].frame.h, f[g].filename, h)), f[g].trimmed && d.setTrim(f[g].trimmed, f[g].sourceSize.w, f[g].sourceSize.h, f[g].spriteSourceSize.x, f[g].spriteSourceSize.y, f[g].spriteSourceSize.w, f[g].spriteSourceSize.h)
        }
        return e
        ...
        var d, e = new b.FrameData, f = c.frames, g = 0;
        for (var h in f) {
            var i = a.rnd.uuid();
            d = e.addFrame(new b.Frame(g, f[h].frame.x, f[h].frame.y, f[h].frame.w, f[h].frame.h, h, i)), f[h].trimmed && d.setTrim(f[h].trimmed, f[h].sourceSize.w, f[h].sourceSize.h, f[h].spriteSourceSize.x, f[h].spriteSourceSize.y, f[h].spriteSourceSize.w, f[h].spriteSourceSize.h), g++
        }
        return e
        ...
        for (var d, e, f, g, h, i, j, k, l, m, n, o, p = new b.FrameData, q = c.getElementsByTagName("SubTexture"), r = 0; r < q.length; r++)e = a.rnd.uuid(), g = q[r].attributes, f = g.name.nodeValue, h = parseInt(g.x.nodeValue, 10), i = parseInt(g.y.nodeValue, 10), j = parseInt(g.width.nodeValue, 10), k = parseInt(g.height.nodeValue, 10), l = null, m = null, g.frameX && (l = Math.abs(parseInt(g.frameX.nodeValue, 10)), m = Math.abs(parseInt(g.frameY.nodeValue, 10)), n = parseInt(g.frameWidth.nodeValue, 10), o = parseInt(g.frameHeight.nodeValue, 10)), d = p.addFrame(new b.Frame(r, h, i, j, k, f, e)), (null !== l || null !== m) && d.setTrim(!0, j, k, l, m, n, o);
        return p
    }},b.Cache = function (a) {
        ...
        this._images[a] = {url: c, data: d, spriteSheet: !0, frameWidth: e, frameHeight: f, margin: h, spacing: i}, PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d), this._images[a].frameData = b.AnimationParser.spriteSheet(this.game, a, e, f, g, h, i)
    }, addTilemap: function (a, b, c, d) {
        this._tilemaps[a] = {url: b, data: c, format: d}
    }, addTextureAtlas: function (a, c, d, e, f) {
        this._images[a] = {url: c, data: d, spriteSheet: !0}, PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d), f == b.Loader.TEXTURE_ATLAS_JSON_ARRAY ? this._images[a].frameData = b.AnimationParser.JSONData(this.game, e, a) : f == b.Loader.TEXTURE_ATLAS_JSON_HASH ? this._images[a].frameData = b.AnimationParser.JSONDataHash(this.game, e, a) : f == b.Loader.TEXTURE_ATLAS_XML_STARLING && (this._images[a].frameData = b.AnimationParser.XMLData(this.game, e, a))
    }, addBitmapFont: function (a, c, d, e, f, g) {
        this._images[a] = {url: c, data: d, spriteSheet: !0}, PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d), b.LoaderParser.bitmapFont(this.game, e, a, f, g)
        ...
        this._images[a] = {url: c, data: d, spriteSheet: !1}, this._images[a].frame = new b.Frame(0, 0, 0, d.width, d.height, a, this.game.rnd.uuid()), PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d)
        ...
        return"undefined" == typeof b && (b = null), "undefined" == typeof c && (c = null), "undefined" == typeof d && (d = this), null === b && null === c ? (console.warn("Phaser.Loader.pack - Both url and data are null. One must be set."), this) : (c && "string" == typeof c && (c = JSON.parse(c)), this._packList.push({key: a, url: b, data: c, loaded: !1, error: !1, callbackContext: d}), this)
        ...
        if (d.loaded = !0, c)var e = JSON.parse(this._xhr.responseText); else var e = this._packList[a].data;
        if (e[d.key])for (var f, g = 0; g < e[d.key].length; g++)switch (f = e[d.key][g], f.type) {
            case"image":
        ...
        this._packList[a].loaded = !0, this._packList[a].error = !0, this.onFileError.dispatch(this._packList[a].key, this._packList[a]), console.warn("Phaser.Loader error loading pack file: " + this._packList[a].key + " from URL " + this._packList[a].url), this.nextPack(a, !0)
        ...
        switch (this.onFileStart.dispatch(this.progress, a.key), a.type) {
            ...
            case"json":
                ...
                break;
            case"tilemap":
                if (a.format === b.Tilemap.TILED_JSON)this.xhrLoad(this._fileIndex, this.baseURL + a.url, "text", "jsonLoadComplete", "dataLoadError"); else {
        ...
        switch (c.type) {
            ...
            case"spritesheet":
                ...
                break;
            case"textureatlas":
                if (null == c.atlasURL)this.game.cache.addTextureAtlas(c.key, c.url, c.data, c.atlasData, c.format); else if (d = !1, c.format == b.Loader.TEXTURE_ATLAS_JSON_ARRAY || c.format == b.Loader.TEXTURE_ATLAS_JSON_HASH)this.xhrLoad(this._fileIndex, this.baseURL + c.atlasURL, "text", "jsonLoadComplete", "dataLoadError"); else {
        ...
        for (var i = b.getElementsByTagName("char"), j = 0; j < i.length; j++) {
            ...
            f.chars[k] = {xOffset: parseInt(i[j].getAttribute("xoffset"), 10), yOffset: parseInt(i[j].getAttribute("yoffset"), 10), xAdvance: parseInt(i[j].getAttribute("xadvance"), 10) + d, kerning: {}, texture: PIXI.TextureCache[c] = new PIXI.Texture(PIXI.BaseTextureCache[c], l)}
        }
    ...
    }},b.Utils.Debug.prototype.constructor = b.Utils.Debug,b.Color = {packPixel: function (a, c, d, e) {
        ...
        var f = Math.min(a, c, d), g = Math.max(a, c, d);
        ...
        var f = Math.min(a, c, d), g = Math.max(a, c, d), h = g - f;
        ...
        var i = {r: a || 0, g: b || 0, b: c || 0, a: d || 1, h: e || 0, s: f || 0, l: g || 0, v: h || 0, color: 0};
        ...
        var c = b.Color.getRGB(a), d = b.Color.RGBtoHexstring(a) + "\n";
        ...
        if (0 !== c.length && a.exists) {
            ...
            var f = new b.Rectangle(a.x, a.y, 1, 1), g = [];
    ...
    },Object.defineProperty(b.Particles.Arcade.Emitter.prototype, "width", {get: function () {
        return this.area.width
    }, set: function (a) {
        this.area.width = a
    }}),Object.defineProperty(b.Particles.Arcade.Emitter.prototype, "height", {get: function () {
    ...
    },b.Tilemap.CSV = 0,b.Tilemap.TILED_JSON = 1,b.Tilemap.NORTH = 0,b.Tilemap.EAST = 1,b.Tilemap.SOUTH = 2,b.Tilemap.WEST = 3,b.Tilemap.prototype = {create: function (a, b, c, d, e, f) {
        ...
        for (var h, i = {name: a, x: 0, y: 0, width: c, height: d, widthInPixels: c * e, heightInPixels: d * f, alpha: 1, visible: !0, properties: {}, indexes: [], callbacks: [], bodies: [], data: null}, j = [], k = 0; d > k; k++) {
            h = [];
    ...
    }},b.Tilemap.prototype.constructor = b.Tilemap,Object.defineProperty(b.Tilemap.prototype, "layer", {get: function () {
        ...
        if (this.layer.dirty && (this.dirty = !0), this.dirty && this.visible) {
            ...
            for (var d = this._mc.startY, e = this._mc.startY + this._mc.maxY; e > d; d++) {
                if (this._column = null, 0 > d && this.wrap ? this._column = this.layer.data[d + this.map.height] : d >= this.map.height && this.wrap ? this._column = this.layer.data[d - this.map.height] : this.layer.data[d] && (this._column = this.layer.data[d]), this._column)for (var f = this._mc.startX, g = this._mc.startX + this._mc.maxX; g > f; f++) {
                    var a = null;
        ...
        for (var a = this._mc.startY, b = this._mc.startY + this._mc.maxY; b > a; a++) {
            if (this._column = null, 0 > a && this.wrap ? this._column = this.layer.data[a + this.map.height] : a >= this.map.height && this.wrap ? this._column = this.layer.data[a - this.map.height] : this.layer.data[a] && (this._column = this.layer.data[a]), this._column)for (var c = this._mc.startX, d = this._mc.startX + this._mc.maxX; d > c; c++) {
                var e = null;
        ...
        for (var e = [], f = 0; f < a.layers.length; f++)if ("tilelayer" === a.layers[f].type) {
            var g = {name: a.layers[f].name, x: a.layers[f].x, y: a.layers[f].y, width: a.layers[f].width, height: a.layers[f].height, widthInPixels: a.layers[f].width * a.tilewidth, heightInPixels: a.layers[f].height * a.tileheight, alpha: a.layers[f].opacity, visible: a.layers[f].visible, properties: {}, indexes: [], callbacks: [], bodies: []};
        ...
        d.layers = e;
        for (var m = [], f = 0; f < a.layers.length; f++)if ("imagelayer" === a.layers[f].type) {
            var n = {name: a.layers[f].name, image: a.layers[f].image, x: a.layers[f].x, y: a.layers[f].y, alpha: a.layers[f].opacity, visible: a.layers[f].visible, properties: {}};
            a.layers[f].properties && (n.properties = a.layers[f].properties), m.push(n)
        }
        d.images = m;
        for (var o = [], f = 0; f < a.tilesets.length; f++) {
            var p = a.tilesets[f], q = new b.Tileset(p.name, p.firstgid, p.tilewidth, p.tileheight, p.margin, p.spacing, p.properties);
        ...
        d.tilesets = o;
        for (var r = {}, s = {}, f = 0; f < a.layers.length; f++)if ("objectgroup" === a.layers[f].type) {
            r[a.layers[f].name] = [], s[a.layers[f].name] = [];
            for (var t = 0, l = a.layers[f].objects.length; l > t; t++)if (a.layers[f].objects[t].gid) {
                var u = {gid: a.layers[f].objects[t].gid, name: a.layers[f].objects[t].name, x: a.layers[f].objects[t].x, y: a.layers[f].objects[t].y, visible: a.layers[f].objects[t].visible, properties: a.layers[f].objects[t].properties};
                r[a.layers[f].name].push(u)
            } else if (a.layers[f].objects[t].polyline) {
                var u = {name: a.layers[f].objects[t].name, x: a.layers[f].objects[t].x, y: a.layers[f].objects[t].y, width: a.layers[f].objects[t].width, height: a.layers[f].objects[t].height, visible: a.layers[f].objects[t].visible, properties: a.layers[f].objects[t].properties};
                u.polyline = [];
        ...
        for (var f = 0; f < d.tilesets.length; f++)for (var p = d.tilesets[f], h = p.tileMargin, w = p.tileMargin, x = 0, y = 0, z = 0, k = p.firstgid; k < p.firstgid + p.total && (d.tiles[k] = [h, w, f], h += p.tileWidth + p.tileSpacing, x++, x !== p.total) && (y++, y !== p.columns || (h = p.tileMargin, w += p.tileHeight + p.tileSpacing, y = 0, z++, z !== p.rows)); k++);
        return d
...
}}), Phaser.Physics.Ninja.Body.render = function (a, b, c, d) {
    c = c || "rgba(0,255,0,0.4)", "undefined" == typeof d && (d = !0), (b.aabb || b.circle) && b.shape.render(a, b.game.camera.x, b.game.camera.y, c, d)
    ...
    var f = this.pos.x - this.xw - b, g = this.pos.y - this.yw - c;
    e ? (a.fillStyle = d, a.fillRect(f, g, this.width, this.height)) : (a.strokeStyle = d, a.strokeRect(f, g, this.width, this.height))
    ...
    var f = this.pos.x - b, g = this.pos.y - c;
    a.beginPath(), a.arc(f, g, this.radius, 0, 2 * Math.PI, !1), e ? (a.fillStyle = d, a.fill()) : (a.strokeStyle = d, a.stroke())
}}, !function (a) {
    ...
    return function a(b, c, d) {
        ...
        b.exports = {name: "p2", version: "0.5.0", description: "A JavaScript 2D physics engine.", author: "Stefan Hedman <schteppe@gmail.com> (http://steffe.se)", keywords: ["p2.js", "p2", "physics", "engine", "2d"], main: "./src/p2.js", engines: {node: "*"}, repository: {type: "git", url: "https://github.com/schteppe/p2.js.git"}, bugs: {url: "https://github.com/schteppe/p2.js/issues"}, licenses: [
            {type: "MIT"}
        ], devDependencies: {grunt: "~0.4.0", "grunt-contrib-jshint": "~0.9.2", "grunt-contrib-nodeunit": "~0.1.2", "grunt-contrib-uglify": "~0.4.0", "grunt-contrib-watch": "~0.5.0", "grunt-browserify": "~2.0.1", "z-schema": "~2.4.6"}, dependencies: {"poly-decomp": "0.1.0", "gl-matrix": "2.1.0"}}
    }, {}], 8: [function (a, b) {
        function c(a) {
    ...
    }, {"../math/vec2": 30, "../utils/Utils": 47}], 9: [function (a, b) {
        function c(a) {
        ...
        function c(a) {
            d.apply(this), a = e.defaults(a, {xmin: -100, xmax: 100, ymin: -100, ymax: 100, nx: 10, ny: 10}), this.xmin = a.xmin, this.ymin = a.ymin, this.xmax = a.xmax, this.ymax = a.ymax, this.nx = a.nx, this.ny = a.ny, this.binsizeX = (this.xmax - this.xmin) / this.nx, this.binsizeY = (this.ymax - this.ymin) / this.ny
        }
    ...
    }, {"../collision/Broadphase": 9, "../math/vec2": 30, "../shapes/Circle": 35, "../shapes/Particle": 39, "../shapes/Plane": 40, "../utils/Utils": 47}], 11: [function (a, b) {
        function c() {
            d.call(this, d.NAIVE)
        }
        ...
        b.exports = c;
        var s = f.fromValues(0, 1), t = f.fromValues(0, 0), u = f.fromValues(0, 0), v = f.fromValues(0, 0), w = f.fromValues(0, 0), x = f.fromValues(0, 0), y = f.fromValues(0, 0), z = f.fromValues(0, 0), A = f.fromValues(0, 0), B = f.fromValues(0, 0), C = f.fromValues(0, 0), D = f.fromValues(0, 0), E = f.fromValues(0, 0), F = f.fromValues(0, 0), G = f.fromValues(0, 0), H = f.fromValues(0, 0), I = f.fromValues(0, 0), J = f.fromValues(0, 0), K = f.fromValues(0, 0), L = [];
        c.prototype.collidedLastStep = function (a, b) {
            ...
            for (var a = 0; a !== this.contactEquations.length; a++) {
                var b = this.contactEquations[a], c = 0 | b.bodyA.id, d = 0 | b.bodyB.id;
                this.collidingBodiesLastStep.set(c, d, !0)
            }
            if (this.reuseObjects) {
                var e = this.contactEquations, f = this.frictionEquations, g = this.reusableFrictionEquations, h = this.reusableContactEquations;
        ...
        var O = f.create(), P = f.create(), Q = new r(1, 1);
        c.prototype[q.CAPSULE | q.CAPSULE] = c.prototype.capsuleCapsule = function (a, b, c, e, g, h, i, j, k) {
            ...
            var n = t, o = u, p = v, q = w, r = x, C = y, D = z, E = A, F = B, G = L;
            ...
            var p = j, q = l, r = e, s = k, H = c, I = a, J = b, n = n || 0, o = "undefined" != typeof o ? o : J.radius, K = t, M = u, N = v, O = w, P = x, Q = y, R = z, S = A, T = B, U = C, V = D, W = E, X = F, Y = G, Z = L;
            ...
            var o = j, p = l, q = i, r = k, s = c, y = a, z = b, n = "number" == typeof n ? n : z.radius, A = t, B = u, E = v, J = w, K = x, L = C, M = D, N = F, O = G, P = H, Q = I, R = !1, S = Number.MAX_VALUE;
            verts = o.vertices;
        ...
        var R = f.create(), S = f.create(), T = f.create(), U = f.create();
        c.prototype[q.PARTICLE | q.CONVEX] = c.prototype[q.PARTICLE | q.RECTANGLE] = c.prototype.particleConvex = function (a, b, c, d, j, k, l, m, n) {
            var o = k, p = m, q = j, r = l, s = c, A = a, B = t, D = u, E = v, G = w, H = x, I = y, L = z, M = C, N = F, O = J, P = K, Q = Number.MAX_VALUE, R = !1, S = o.vertices;
            ...
            var o = a, p = b, q = c, r = e, s = i, u = j, v = t, m = m || p.radius, n = n || s.radius;
            g(v, c, j);
            var w = m + n;
            ...
            var o = j, p = l, q = k, r = m, w = a, x = b, y = d, z = e, A = t, B = u, C = v, D = 0;
            f.rotate(B, s, z);
            ...
            var m = a, n = c, o = e, p = j, q = k, r = t, v = u;
        ...
        {
            var V = new o(1), W = f.create(), X = f.create();
            f.create()
        }
        c.prototype[q.PLANE | q.CAPSULE] = c.prototype.planeCapsule = function (a, b, c, d, e, g, i, j, k) {
            ...
            var p = t, q = u, r = v, s = w, y = x, C = z, D = A, E = B, F = 0, o = o || c.convexPrecision, G = c.findSeparatingAxis(b, d, e, k, l, m, p);
            if (!G)return 0;
        ...
        var Z = f.fromValues(0, 0), $ = f.fromValues(0, 0), _ = f.fromValues(0, 0), ab = f.fromValues(0, 0), bb = f.fromValues(0, 0), cb = f.fromValues(0, 0);
        ...
        var db = f.fromValues(0, 0), eb = f.fromValues(0, 0), fb = f.fromValues(0, 0);
        ...
        var gb = f.create(), hb = f.create(), ib = f.create(), jb = f.create(), kb = f.create(), lb = f.create(), mb = f.create();
        c.prototype[q.CIRCLE | q.HEIGHTFIELD] = c.prototype.circleHeightfield = function (a, b, c, d, e, i, j, k, l, m) {
            var n = i.data, m = m || b.radius, o = i.elementWidth, p = hb, q = gb, r = kb, s = mb, t = lb, u = ib, v = jb, w = Math.floor((c[0] - m - j[0]) / o), x = Math.ceil((c[0] + m - j[0]) / o);
            ...
            if (B = !1, m > 0)for (var A = w; x >= A; A++)if (f.set(u, A * o, n[A]), f.add(u, u, j), f.sub(p, c, u), f.squaredLength(p) < m * m) {
                if (l)return!0;
                B = !0;
                var D = this.createContactEquation(e, a, i, b);
        ...
        var nb = f.create(), ob = f.create(), pb = f.create(), qb = new p([f.create(), f.create(), f.create(), f.create()]);
        c.prototype[q.RECTANGLE | q.HEIGHTFIELD] = c.prototype[q.CONVEX | q.HEIGHTFIELD] = c.prototype.convexHeightfield = function (a, b, c, d, e, g, h, i, j) {
            var k = g.data, l = g.elementWidth, m = nb, n = ob, o = pb, p = qb, q = Math.floor((a.aabb.lowerBound[0] - h[0]) / l), r = Math.ceil((a.aabb.upperBound[0] - h[0]) / l);
    ...
    }, {"../equations/ContactEquation": 21, "../equations/Equation": 22, "../equations/FrictionEquation": 23, "../math/vec2": 30, "../objects/Body": 31, "../shapes/Circle": 35, "../shapes/Convex": 36, "../shapes/Rectangle": 41, "../shapes/Shape": 42, "../utils/TupleDictionary": 46, "../utils/Utils": 47}], 13: [function (a, b) {
        function c() {
        ...
        b.exports = c, c.prototype = new e, c.prototype.setWorld = function (a) {
            ...
            var a = this.axisList, b = this.result, d = this.axisIndex;
            b.length = 0;
            ...
            c.sortAxisList(a, d);
            for (var h = 0, i = 0 | a.length; h !== i; h++)for (var j = a[h], k = h + 1; i > k; k++) {
                var l = a[k], m = l.aabb.lowerBound[d] <= j.aabb.upperBound[d];
                if (!m)break;
                e.canCollide(j, l) && this.boundingVolumeCheck(j, l) && b.push(j, l)
            }
            return b
        }
    }, {"../collision/Broadphase": 9, "../utils/Utils": 47}], 14: [function (a, b) {
        function c(a, b, c, e) {
            this.type = c, e = d.defaults(e, {collideConnected: !0, wakeUpBodies: !0}), this.equations = [], this.bodyA = a, this.bodyB = b, this.collideConnected = e.collideConnected, e.wakeUpBodies && (a && a.wakeUp(), b && b.wakeUp())
        }
        ...
        c.prototype.update = function () {
            var a = this.equations[0], b = this.bodyA, c = this.bodyB, d = (this.distance, b.position, c.position, a.G);
        ...
        c.prototype.computeGq = function () {
            ...
            var a = this.G, b = this.bodyA, c = this.bodyB, e = b.velocity, f = c.velocity, g = b.angularVelocity, h = c.angularVelocity;
        ...
        c.prototype.computeGiMf = function () {
            var a = this.bodyA, b = this.bodyB, c = a.force, h = a.angularForce, i = b.force, j = b.angularForce, k = e(a), n = e(b), o = f(a), p = f(b), q = this.G;
    ...
    }, {"../math/vec2": 30, "../objects/Body": 31, "../utils/Utils": 47}], 23: [function (a, b) {
        function c(a, b, c) {
    ...
    }, {"../math/vec2": 30, "../utils/Utils": 47, "./Equation": 22}], 24: [function (a, b) {
        function c(a, b, c) {
    ...
    }, {"../math/vec2": 30, "../utils/Utils": 47}], 33: [function (a, b) {
    ...
    }, {"../package.json": 7, "./collision/AABB": 8, "./collision/Broadphase": 9, "./collision/GridBroadphase": 10, "./collision/NaiveBroadphase": 11, "./collision/Narrowphase": 12, "./collision/SAPBroadphase": 13, "./constraints/Constraint": 14, "./constraints/DistanceConstraint": 15, "./constraints/GearConstraint": 16, "./constraints/LockConstraint": 17, "./constraints/PrismaticConstraint": 18, "./constraints/RevoluteConstraint": 19, "./equations/AngleLockEquation": 20, "./equations/ContactEquation": 21, "./equations/Equation": 22, "./equations/FrictionEquation": 23, "./equations/RotationalVelocityEquation": 25, "./events/EventEmitter": 26, "./material/ContactMaterial": 27, "./material/Material": 28, "./math/vec2": 30, "./objects/Body": 31, "./objects/Spring": 32, "./shapes/Capsule": 34, "./shapes/Circle": 35, "./shapes/Convex": 36, "./shapes/Heightfield": 37, "./shapes/Line": 38, "./shapes/Particle": 39, "./shapes/Plane": 40, "./shapes/Rectangle": 41, "./shapes/Shape": 42, "./solver/GSSolver": 43, "./solver/Solver": 44, "./utils/Utils": 47, "./world/World": 51}], 34: [function (a, b) {
        function c(a, b) {
        ...
        function c(a, b) {
            if (b = e.defaults(b, {maxValue: null, minValue: null, elementWidth: .1}), null === b.minValue || null === b.maxValue) {
    ...
    }, {"../math/vec2": 30, "../utils/Utils": 47, "./Shape": 42}], 38: [function (a, b) {
        function c(a) {
    ...
    }, {"../math/vec2": 30, "../utils/Utils": 47, "./Shape": 42}], 41: [function (a, b) {
        function c(a, b) {
            a = a || 1, b = b || 1;
    ...
    }, {"../equations/FrictionEquation": 23, "../math/vec2": 30, "../utils/Utils": 47, "./Solver": 44}], 44: [function (a, b) {
        function c(a, b) {
    ...
    }, {"../events/EventEmitter": 26, "../utils/Utils": 47}], 45: [function (a, b) {
        function c() {
    ...
    }, {"./TupleDictionary": 46, "./Utils": 47}], 46: [function (a, b) {
        function c() {
            this.data = [], this.keys = []
        }
    ...
    }, {"../objects/Body": 31}], 49: [function (a, b) {
        function c() {
    ...
    }, {"../math/vec2": 30, "../objects/Body": 31, "./Island": 48, "./IslandNode": 50}], 50: [function (a, b) {
        function c(a) {
        ...
        var L = (j.create(), j.create(), j.create(), j.create(), j.create(), j.create(), j.create()), M = j.fromValues(0, 0), N = j.fromValues(0, 0), O = (j.fromValues(0, 0), j.fromValues(0, 0));
        ...
        c.prototype.internalStep = function (a) {
            this.stepping = !0;
            var b, d, e = this, f = this.doProfiling, g = this.springs.length, h = this.springs, i = this.bodies, k = this.gravity, l = this.solver, m = this.bodies.length, n = this.broadphase, o = this.narrowphase, p = this.constraints, q = L, r = (j.scale, j.add), t = (j.rotate, this.islandManager);
            ...
            for (var v = 0, E = z.length; v !== E; v += 2)for (var F = z[v], G = z[v + 1], I = 0, J = F.shapes.length; I !== J; I++)for (var K = F.shapes[I], M = F.shapeOffsets[I], N = F.shapeAngles[I], O = 0, Q = G.shapes.length; O !== Q; O++) {
                var R = G.shapes[O], S = G.shapeOffsets[O], T = G.shapeAngles[O], U = this.defaultContactMaterial;
            ...
            if (f && (d = performance.now(), e.lastStepTime = d - b), this.emitImpactEvent && this.has("impact"))for (var _ = this.impactEvent, v = 0; v !== o.contactEquations.length; v++) {
                ...
                if (p) {
                    ...
                    if (q) {
                        if (b.allowSleep && b.motionState === s.DYNAMIC && b.sleepState === s.SLEEPING && f.sleepState === s.AWAKE && f.motionState !== s.STATIC) {
                            var v = j.squaredLength(f.velocity) + Math.pow(f.angularVelocity, 2), w = Math.pow(f.sleepSpeedLimit, 2);
                        ...
                        if (f.allowSleep && f.motionState === s.DYNAMIC && f.sleepState === s.SLEEPING && b.sleepState === s.AWAKE && b.motionState !== s.STATIC) {
                            var x = j.squaredLength(b.velocity) + Math.pow(b.angularVelocity, 2), y = Math.pow(b.sleepSpeedLimit, 2);
                        ...
                        if ("number" == typeof q && u > 1)for (var A = a.frictionEquations.length - u; A < a.frictionEquations.length; A++) {
        ...
        var S = j.create(), T = j.fromValues(0, 0), U = j.fromValues(0, 0);
        c.prototype.hitTest = function (a, b, c) {
            c = c || 0;
            var d = new s({position: a}), e = new q, f = a, g = 0, h = S, i = T, l = U;
            d.addShape(e);
    ...
    "undefined" == typeof d && (d = 100), this.game = a.game, this.world = a, d = a.pxm(d), p2.DistanceConstraint.call(this, b, c, d, {maxForce: e})
    ...
    "undefined" == typeof f && (f = Number.MAX_VALUE), this.game = a.game, this.world = a, c = [a.pxmi(c[0]), a.pxmi(c[1])], e = [a.pxmi(e[0]), a.pxmi(e[1])], p2.RevoluteConstraint.call(this, b, c, d, e, {maxForce: f})
